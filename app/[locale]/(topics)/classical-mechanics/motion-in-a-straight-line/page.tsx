...
const SLUG = "classical-mechanics/motion-in-a-straight-line";
...
export default async function Page({
  ...
  return (
    <TopicPageLayout aside={aside}>
      ...
      <ProblemsSection topicSlug="motion-in-a-straight-line" branchSlug="classical-mechanics" locale={locale} />
