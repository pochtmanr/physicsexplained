...
<SceneCard caption="FIG.02a — Taylor approximations of sin θ" className="w-full">
...
<SceneCard caption="FIG.02d — the potential well" className="w-full">
...
<SceneCard caption="FIG.02e — phase portrait with separatrix" className="w-full">
  <SeparatrixScene />
</SceneCard>
...
<SceneCard caption="FIG.02f — period stretches with amplitude" className="w-full">
