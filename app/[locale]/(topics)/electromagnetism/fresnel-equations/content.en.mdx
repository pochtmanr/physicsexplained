...
Solve that system and out pops a set of formulas that tell you — for any incidence angle, for any polarisation, for any index pair — the amplitude of the reflected wave and the amplitude of the transmitted wave. They were written down by <PhysicistLink slug="augustin-fresnel">Augustin Fresnel</PhysicistLink> in 1821, a decade before Maxwell proved that light was what they were talking about. They are called the <Term slug="fresnel-equations">Fresnel equations</Term>, and they are the answer to every reflection question a classical beam can ask.
