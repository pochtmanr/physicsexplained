...
describe("UsageMeter", () => {
  it("renders free plan as questions remaining", () => {
    render(<UsageMeter snapshot={{
      ...
      percentUsed: 67,
      cycleEnd: "2026-05-23T00:00:00Z", nextChargeAt: null, canceledAt: null, appleExpiresAt: null,
    } as const} />);
  ...
  it("renders paid plan with tokens and ≈ questions", () => {
    render(<UsageMeter snapshot={{
      ...
      percentUsed: 25,
      cycleEnd: "2026-05-23T00:00:00Z", nextChargeAt: "2026-05-23T00:00:00Z", canceledAt: null, appleExpiresAt: null,
    } as const} />);
