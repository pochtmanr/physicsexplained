  ...
  useAnimationFrame({
    ...
    onFrame: (t) => {
      ...
      for (const p of pends) {
        ...
        ctx.fillStyle = "#6FB8C6"; ctx.beginPath(); ctx.arc(bx, by, 8, 0, Math.PI * 2); ctx.fill(); ctx.shadowBlur = 0;
        ...
        ctx.strokeStyle = "#6FB8C6"; ctx.lineWidth = 2; ctx.beginPath(); ctx.moveTo(barL, barY); ctx.lineTo(barL + barW * frac, barY); ctx.stroke();
      }
